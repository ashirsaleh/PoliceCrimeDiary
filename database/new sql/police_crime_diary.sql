...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 30, 2021 at 09:16 PM
...
(1, 690, 'mohamed', 'killing ', 'sentenced to death', '0000-00-00', 'UNSOLVED CASE');
...
INSERT INTO `complainers` (`complainer_id`, `Fname`, `Lname`, `address`, `date`, `p_number`, `time`, `nature_complaints`, `th_name`, `location`, `short_info`, `car_name`, `plate_number`, `color`, `wit_statement`) VALUES
